...
\end{center}
\vspace{12pt}
\parbox{\linewidth}{All images provided by Alex Fry, Technology Director, Psycle
...
\begin{center}
\vspace{-0.5cm}
\includegraphics[width=1\textwidth,height=0.75\textheight,keepaspectratio]{figure/PICO_34.PNG}
\end{center}

\parbox{\linewidth}{All images provided by Alex Fry of Psycle
\\Property of Ubisoft Hieroglyphics Initiative Workbench}
